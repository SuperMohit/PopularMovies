...
public class Movie implements Serializable{
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(posterPath)
                .append(adult).append(overview)
                .append(releaseDate).append(genreIds)
                .append(id).append(originalTitle)
                .append(originalLanguage)
                .append(title).append(backdropPath)
                .append(popularity)
                .append(voteCount)
                .append(video)
                .append(voteAverage)
